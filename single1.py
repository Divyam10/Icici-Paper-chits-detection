...
with tf.Session() as sess:
    ...
    imagePaths = list(paths.list_images("icici videos/New Folder/2"))
    ...
    img = cv2.imread('icici videos/New Folder/3/c316110.jpg')
    rows = img.shape[0]
    cols = img.shape[1]
    ...
    if person==True: 
        img = cv2.putText(img,'Person is present',(23,100), font, 1,(169, 245, 159),4,cv2.LINE_AA)
    ...
    # img = image[249:375,202:394]
        ...
        for i in range(len(contours)):
            ...
            print(cX,cY)
            point = Point(cX, cY)
            polygon = Polygon([(42,139),(80,286),(350,279),(216,206),(213,159),(151,99)])
        ...
        font = cv2.FONT_HERSHEY_SIMPLEX 
        if pointer>2:
            image = cv2.putText(img,'May not be clean',(23,100), font, 1,(12, 12, 232),4,cv2.LINE_AA)
        else:
            image = cv2.putText(img,'may be clean',(23,100), font, 1,(169, 245, 159),4,cv2.LINE_AA)
