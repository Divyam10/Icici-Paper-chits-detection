...
with tf.Session() as sess:
    ...
    for k in range(1,30):
        ...
        img = cv2.imread('mobilenet/new2/u ({}).jpg'.format(k))
        rows = img.shape[0]
        cols = img.shape[1]
        ...
        if person==True: 
            img = cv2.putText(img,'Person is present',(23,370), font, 1,(169, 245, 159),4,cv2.LINE_AA)
        ...
        # img = image[249:375,202:394]
            ...
            for i in range(len(contours)):
                ...
                if M["m00"]==0:
                    ...
                    print(cX,cY)
                    point = Point(cX, cY)
                    polygon = Polygon([(206,245),(389,243),(389,369),(224,380), (188,300)])
            ...
            font = cv2.FONT_HERSHEY_SIMPLEX 
            if pointer>2:
                image = cv2.putText(img,'May not be clean',(23,370), font, 1,(12, 12, 232),4,cv2.LINE_AA)
            else:
                image = cv2.putText(img,'may be clean',(23,370), font, 1,(169, 245, 159),4,cv2.LINE_AA)
